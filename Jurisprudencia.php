...
function loadTour1JU(a){
      switch (a){
      case 'FILOSOFIA': $("#contenido").load("FilosofiaLetras.php");
      break;
      case 'INGRESAR': $("#contenido").load("InteriorJurisprudencia.php");
      break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1JU('FILOSOFIA')" class="btn btn-warning btn-sm">FACULTAD DE FILOSOFIA</button>
						<button type="button" onclick="loadTour1JU('INGRESAR')" class="btn btn-info btn-sm">INGRESAR A LA FACULTAD</button>
...
<div class="modal fade" id="mostrarmodalinicio" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
           ...
           <div class="modal-body">
	         <center>
						<button type="button" onclick="loadTour1JU('REGRESAR')" class="btn btn-primary btn-lg">REGRESAR AL INICIO</button></a>
	         </center>
           </div>
      </div>
   </div>
