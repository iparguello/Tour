...
function loadTourP(a){
      switch (a){
      case 'PSICOLOGIA': $("#contenido").load("InteriorPsicologia.php");
      break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTourP('PSICOLOGIA')" class="btn btn-info btn-sm">INGRESAR A LA FACULTAD</button>
              			
	      				<button type="button" onclick="loadTourP('QUIMICA')" class="btn btn-warning btn-sm">FACULTAD DE QUIMICA</button>
					</center>
           			</div>
      			</div>
   		</div>
