 <?php
$nombre_carpeta="src/IngresoPsicologia";
$cantidad=475;
$imagen=1;
 ?>            
...
function loadTour1Psic(a){
      switch (a){
      case 'SALIR': $("#contenido").load("Quimica.php");
      break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1Psic('SALIR')" class="btn btn-info btn-sm">SALIR</button>
