<?php
$nombre_carpeta="src/IngresoOdontologia";
$cantidad=673;
$imagen=1;
 ?>  
<html>	
...
function loadTour1IO(a){
      switch (a){
      case 'SALIR': $("#contenido").load("TerminacionOdontologia.php");
      break;
      default: break;
      }
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1IO('SALIR')" class="btn btn-warning btn-sm">SALIR</button>
						</center>
           			</div>
      			</div>
   		</div>
