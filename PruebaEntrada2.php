...
<head>
	<script language="javascript" type="text/javascript">
		...
		function loadTourPE2(a){
			  switch (a){
			  case 'CIENCIAS-MEDICAS': $("#contenido").load("CienciasMedicas.php");
			  break;
			  case 'ODONTOLOGIA': $("#contenido").load("Odontologia.php");
			  break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button" onclick="loadTourPE2('CIENCIAS-MEDICAS')" class="btn btn-warning btn-sm">FACULTAD DE CIENCIAS MÉDICAS</button>
						<button type="button"  onclick="loadTourPE2('ODONTOLOGIA')" class="btn btn-info btn-sm">FACULTAD DE ODONTOLOGÍA</button>
