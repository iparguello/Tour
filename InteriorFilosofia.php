 <?php
$nombre_carpeta="src/IngresoFilosofia";
$cantidad=461;
$imagen=1;
 ?>            
...
function loadTour1IFI(a){
        switch (a){
      case 'SALIR': $("#contenido").load("PruebaEntrada4.php");
      break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1IFI('SALIR')" class="btn btn-info btn-sm">REGRESAR AL PUNTO DE INICIO</button>
