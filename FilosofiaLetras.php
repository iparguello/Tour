...
function loadTourFi(a){
      switch (a){
      case 'INGRESAR': $("#contenido").load("InteriorFilosofia.php");
      break;
      case 'CONTINUAR': $("#contenido").load("PruebaEntrada4.php");
      break;
	  default: break;
      }
...
<!------- Carga ---------->
	<center>
		<img class="img-thumbnail" src=<?php echo $nombre_carpeta.'/escene644.jpg'?> alt="Secuencia" name="secuencia">
	</center>
<!------- END Carga ---------->
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTourFi('CONTINUAR')" class="btn btn-info btn-sm">CONTINUAR CON EL RECORRIDO</button>
              			
	      				<button type="button" onclick="loadTourFi('INGRESAR')" class="btn btn-warning btn-sm">INGRESAR A LA FACULTAD</button>
					</center>
           			</div>
      			</div>
   		</div>
