...
<head>
	<script language="javascript" type="text/javascript">
		...
		function loadTourE(a){
			  switch (a){
			  case 'INGRESAR': $("#contenido").load("InteriorEconomia.php");
			  break;
			  case 'MATEMATICAS': $("#contenido").load("Matematica.php");
			  break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTourE('MATEMATICAS')" class="btn btn-info btn-sm">FACULTAD DE MATEMATICAS</button>
              			<button type="button" onclick="loadTourE('INGRESAR')" class="btn btn-warning btn-sm">INGRESAR A LA FACULTAD</button>
