 <?php
$nombre_carpeta="src/IngresoArquitectura";
$cantidad=1295;
$imagen=1;
 ?>            
<!DOCTYPE html>
...
function loadTour1IARQ(a){
            switch (a){
      case 'SALIR': $("#contenido").load("TerminacionArquitectura.php");
      break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1IARQ('SALIR')" class="btn btn-info btn-sm">SALIR</button>
