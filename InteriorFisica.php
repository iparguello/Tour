<?php
$nombre_carpeta="src/IngresoFeder";
$cantidad=917;
$imagen=1;
 ?>            
...
function loadTour1TFI(a){
      switch (a){
      case 'SALIR': $("#contenido").load("TerminacionFeder.php");
      break;
       default: break;
      }
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						...
						<button type="button" onclick="loadTour1TFI('SALIR')" class="btn btn-info btn-sm">SALIR</button>
