<?php
$nombre_carpeta="src/IngresoMedicas";
$cantidad=1093;
$imagen=1;
 ?>  
<html>	
...
function loadTour1IMe(a){
      switch (a){
      case 'SALIR': $("#contenido").load("TerminacionMedicas.php");
      break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1IMe('SALIR')" class="btn btn-warning btn-sm">SALIR</button>
