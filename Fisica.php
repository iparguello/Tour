...
function loadTour1Fis(a){
      switch (a){
      case 'INGRESO': $("#contenido").load("InteriorFisica.php");
      break;
...
<!------- Carga ---------->
	<center>
		<img class="img-thumbnail" src=<?php echo $nombre_carpeta.'/escene1447.jpg'?> alt="Secuencia" name="secuencia">
	</center>
<!------- END Carga ---------->
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1Fis('INGRESO')" class="btn btn-info btn-sm">INGRESAR A LA FACULTAD</button>
              			
	      				<button type="button" onclick="loadTour1Fis('REGRESAR')" class="btn btn-warning btn-sm">REGRESAR AL INICIO</button>
					</center>
           			</div>
      			</div>
   		</div>
