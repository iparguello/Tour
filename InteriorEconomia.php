 <?php
$nombre_carpeta="src/IngresoEconomia";
$cantidad=1571;
$imagen=1;
 ?>            
<!DOCTYPE html>
...
function loadTour1IEc(a){
            switch (a){
      case 'SALIR': $("#contenido").load("Matematica.php");
      break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1IEc('SALIR')" class="btn btn-info btn-sm">REGRESAR AL PUNTO DE INICIO</button>
