 <?php
$nombre_carpeta="src/IngresoQuimica";
$cantidad=775;
$imagen=1;
 ?>            
...
function loadTour1IQ(a){
      switch (a){
      case 'SALIR': $("#contenido").load("Fisica.php");
      break;
      default: break;
      }
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1IQ('SALIR')" class="btn btn-info btn-sm">SALIR</button>
