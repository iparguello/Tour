<?php
$nombre_carpeta="src/IngresoMatematica";
$cantidad=701;
$imagen=1;
 ?>            
...
function loadTour1M(a){
      switch (a){
      case 'SALIR': $("#contenido").load("TerminacionMatematica.php");
      break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1M('SALIR')" class="btn btn-info btn-sm">SALIR</button>
</center>
