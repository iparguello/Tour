...
<!------- Carga ---------->
	<center>
		<img class="img-thumbnail" src=<?php echo $nombre_carpeta.'/escene1539.jpg'?> alt="Secuencia" name="secuencia">
	</center>
<!------- END Carga ---------->
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1TO('CC')" class="btn btn-warning btn-sm">REGRESAR AL EDIFICIO CENTRAL</button>
						<button type="button"  onclick="loadTour1TO('INGRESAR')" class="btn btn-warning btn-sm">INGRESAR A LA  FACULTAD</button>	      				
					</center>
           			</div>
      			</div>
   		</div>
