...
function loadTour1M(a){
      switch (a){
      case 'INGRESAR': $("#contenido").load("InteriorMatematica.php");
      break;
      case 'REGRESARCC': $("#contenido").load("CentroComputo.php");
      break;
...
<!------- Carga ---------->
	<center>
		<img class="img-thumbnail" src=<?php echo $nombre_carpeta.'/escene625.jpg'?> alt="Secuencia" name="secuencia">
	</center>
<!------- END Carga ---------->
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1M('REGRESAR')" class="btn btn-info btn-sm">REGRESAR AL INICIO</button>
						<button type="button"  onclick="loadTour1M('REGRESARCC')" class="btn btn-success btn-sm">REGRESAR AL EDIFICIO CENTRAL</button>
						<button type="button" onclick="loadTour1M('INGRESAR')" class="btn btn-warning btn-sm">INGRESAR A LA FACULTAD</button>
