		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTourCM('REGRESAR')" class="btn btn-info btn-sm">REGRESAR AL RECORRIDO</button>
              			<button type="button" onclick="loadTourCM('INGRESAR')" class="btn btn-warning btn-sm">INGRESAR A LA FACULTAD</button>
