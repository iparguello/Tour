 <?php
$nombre_carpeta="src/IngresoJurisprudencia";
$cantidad=411;
$imagen=1;
 ?>            
...
function loadTour1J(a){
      switch (a){
      case 'SALIR': $("#contenido").load("FilosofiaLetras.php");
      break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1J('SALIR')" class="btn btn-info btn-sm">SALIR</button>
