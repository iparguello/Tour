<?php
$nombre_carpeta="src/IngresoAgraria";
$cantidad=1089;
$imagen=1;
 ?>            
...
function loadTour1IAGR(a){
            switch (a){
      case 'SALIR': $("#contenido").load("TerminacionAgraria.php");
      break;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<center>
						<button type="button"  onclick="loadTour1IAGR('SALIR')" class="btn btn-info btn-sm">SALIR</button>
